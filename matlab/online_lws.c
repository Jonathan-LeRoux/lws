/* ONLINE_LWS.C Construct consistent phase using online LWS updates
...
void mexFunction(int nlhs, mxArray *plhs[], /* Output variables */
    ...
    if (nlhs > 0) {
        ...
        pWflag_ai = malloc(sizeof(int)*mxGetNumberOfElements(WEIGHTS));
        pWflag_af = malloc(sizeof(int)*mxGetNumberOfElements(WEIGHTS));
        ...
        double *thresholds;
        thresholds = malloc(sizeof(double)*iterations);
